...
public class EdXMLBuild {
	public static Content createEdoc_new(
			vn.ript.base.model.Organization from,
			List<vn.ript.base.model.Organization> to_list,
			String code_number,
			String code_notation,
			String promulgation_place,
			String promulgation_date,
			vn.ript.base.model.document.DocumentType document_type,
			String subject,
			String content,
			...
			List<vn.ript.base.model.document.UpdateReceiver> business_bussiness_document_info_receiver_list,
			...
			List<vn.ript.base.model.document.ReplacementInfo> business_replacement_info_list,
		...
		if (to_list != null) {
			for (vn.ript.base.model.Organization to : to_list) {
		...
		if (business_bussiness_document_info_receiver_list != null) {
			for (vn.ript.base.model.document.UpdateReceiver business_bussiness_document_info_receiver : business_bussiness_document_info_receiver_list) {
		...
		if (business_replacement_info_list != null) {
			for (vn.ript.base.model.document.ReplacementInfo business_replacement_info : business_replacement_info_list) {
	...
	public static Content create_status(
			vn.ript.base.model.Organization from,
			vn.ript.base.model.document.Document document,
