...
@RestController
@RequestMapping("api/v1/initialize/ocsp-responders")
@CrossOrigin(origins = "*", allowedHeaders = "*")
public class OcspRespondersController {

    @GetMapping("/{id}")
    public ResponseEntity<Map<String, Object>> getById(
            @PathVariable String id) {
        try {
            String url = Utils.CS_CONFIG_URL + "/ocsp-responders/" + id;
    ...
    public ResponseEntity<Map<String, Object>> getCertOfOCSPResponder(
            @PathVariable String id) {
        try {
            String url = Utils.CS_CONFIG_URL + "/ocsp-responders/" + id + "/certificate";
            Map<String, String> headers = Map.ofEntries(
                    Map.entry("Authorization", "X-Road-ApiKey token=" + Utils.CS_API_KEY),
                    Map.entry("Accept", "application/json"));
            CustomHttpRequest httpRequest = new CustomHttpRequest("GET", url, headers);
    ...
    public ResponseEntity<Map<String, Object>> editById(
        ...
        try {
            ...
            multipartEntityBuilder.addTextBody("url", (String) body.get("url"));
