...
public class BackupController {
    ...
    public ResponseEntity<Map<String, Object>> getAll() {
        try {
            String url = Utils.SS_CONFIG_URL + "/backups";
    ...
    @PostMapping("/ext")
    public ResponseEntity<Map<String, Object>> createExt() {
        try {
            String url = Utils.SS_CONFIG_URL + "/backups/ext";
            Map<String, String> headers = Map.ofEntries(
                    Map.entry("Authorization", "X-Road-ApiKey token=" + Utils.SS_API_KEY),
                    Map.entry("Content-Type", "application/json"),
                    Map.entry("Accept", "application/json"));
    ...
    public ResponseEntity<Map<String, Object>> deleteByFilename(
        ...
        try {
            String url = Utils.SS_CONFIG_URL + "/backups/" + filename;
            Map<String, String> headers = Map.ofEntries(
                    Map.entry("Authorization", "X-Road-ApiKey token=" + Utils.SS_API_KEY),
                    Map.entry("Content-Type", "application/json"),
                    Map.entry("Accept", "application/json"));
    ...
    public ResponseEntity<InputStreamResource> downloadByFilename(
            @PathVariable String filename) {
        try {
            String url = Utils.SS_CONFIG_URL + "/backups/" + filename + "/download";
            Map<String, String> headers = Map.ofEntries(
                    Map.entry("Authorization", "X-Road-ApiKey token=" + Utils.SS_API_KEY),
                    Map.entry("Content-Type", "application/json"),
