...
import vn.ript.base.repository.DocumentCatalogRequestRepository;
...
public class DocumentCatalogRequestService {
    ...
    public List<DocumentCatalogRequest> findSentWithConditions(
            String status,
            String organizationId,
            String documentCatalogId,
            String sortTimestamp) {
    ...
    public List<DocumentCatalogRequest> findReceivedWithConditions(
            String status,
            String organizationId,
            String documentCatalogId,
            String sortTimestamp) {
